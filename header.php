...
<h4> This is Addis Ababa University Teacher and Admin Consumer Association System</4>
	<!-- bootstrap -->
...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
		...
		<?php } ?> 
    <?php  if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        <li id="importbrand"><a href="importbrand.php"> <i class="glyphicon glyphicon-check"></i> </a></li>
		<?php } ?>   
